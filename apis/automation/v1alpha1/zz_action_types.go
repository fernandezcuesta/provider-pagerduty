...
type ActionInitParameters struct {
	...
	// Whether or not the action can be invoked automatically from a PagerDuty Event Orchestration.
	...
	// Whether or not the action can be invoked manually by a user on the PagerDuty website.
